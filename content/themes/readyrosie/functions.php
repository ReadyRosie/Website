...
function twentyeleven_setup() {
	...
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyeleven_header_image_height', 89 ) );
...
function twentyeleven_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Post Widgets', 'ReadyRosie' ),
		'id' => 'postwidgets',
...
function my_scripts_method() {
   ...
   wp_register_script('fancybox',
       get_template_directory_uri() . '/js/fancybox/jquery.fancybox-1.3.4.pack.js',
       array('jquery'),
       '1.0' );
   // enqueue the script
...
global $wpdb; 
    if ($wpdb->last_result[0]->post_status == "private" && !is_admin() ):
        wp_redirect( "http://readyrosie.com/?page_id=222", 301 );
        exit();
    endif;
}
...
/*function my_front_end_login_fail( $username ) {
   ...
   if ( !empty($referrer) && !strstr($referrer,'wp-login') && !strstr($referrer,'wp-admin') ) {
	...
	else wp_redirect( $referrer . '?login=failed');
      exit;
   }
}*/
...
$message = '<p class="message">Not a member? Check with your local School District to see if they have purchased access for you.</p>';
return $message;
}
