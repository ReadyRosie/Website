...
if(!get_option('wp_private_before_html')) { add_option("wp_private_before_html", '<br/><div id="wp-private-box">This is protected content. ', '', 'yes'); }
if(!get_option('wp_private_after_html')) { add_option("wp_private_after_html", '</div><br/>', '', 'yes'); }
